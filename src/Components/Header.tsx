      ...
      <header className="d-flex p-7">
        ...
        <div className="d-flex flex-stack w-100">
          ...
          <div className="right-header btn.btn-icon">
            ...
            >
              <Image
                src={profileData && profileData.avatar_image ? `${assertUrl}/transportFolder/${profileData.avatar_image}` : `${assertUrl}/assets/img/profile.jpg`}
                alt="Max Smith"
                ...
                <div className="menu-item px-3">
                  <div className="menu-content d-flex align-items-center px-3">
                    <div className="symbol symbol-50px me-5">
                      <Image src={profileData && profileData.avatar_image ? `${assertUrl}/transportFolder/${profileData.avatar_image}` : `${assertUrl}/assets/img/profile.jpg`} width={30} height={30} alt="user" />
                    </div>
