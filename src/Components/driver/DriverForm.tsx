...
function DriverForm({ id }) {
  ...
  const [tokenss, setTokenss] = useState(null);
                        ...
                        <div className="mb-5 row">
                          ...
                          <div className="col-lg-5 col-md-12 col-sm-5">
                            <input
                              ...
                              className={`form-control mb-2 ${
                                errors.carrer_us_dot_number ? "is-invalid" : ""
                              }`}
                        ...
                        <div className="mb-5 row">
                          ...
                          <div className="col-lg-10 col-md-12 col-sm-12">
                            <input
                              ...
                              className={`form-control mb-2 ${
                                errors.main_office_address ? "is-invalid" : ""
                              }`}
                          ...
                          <div className="mb-5 row">
                            ...
                            <div className="col-lg-5 col-md-12 col-sm-5">
                              <input
                                ...
                                className={`form-control mb-2 ${
                                  errors.home_terminal_name ? "is-invalid" : ""
                                }`}
