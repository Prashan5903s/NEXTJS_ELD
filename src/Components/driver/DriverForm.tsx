...
>>>>>>> origin/main
  ...
  async function checkEmailUniqueness(email, id = null) {
    ...
    try {
      ...
      const response = await axios.get(`${url}/check/email/${email}/${emailVal}`, {
        headers: {
  ...
  async function checkUsernameUniqueness(username, id = null) {
    ...
    try {
      ...
      const response = await axios.get(`${url}/check/username/${username}/${usernameVal}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const formValidations = {
    ...
    username: {
      ...
      validate: async (username, id) => {
        const isUniques = await checkUsernameUniqueness(username, id ? id : null);
