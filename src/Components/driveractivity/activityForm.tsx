...
function ActivityForm({ id }) {
    ...
    const debouncedFetchEditActivity = useCallback(debounce(fetchEditActivity, 2000), [fetchEditActivity]);
    ...
    }, 2000), [url, token]); // Adjust debounce delay as needed
    ...
    }, [id, activity, editActivity, selectedDriverStatus]);
                                        ...
                                        <div className="d-flex flex-column">
                                            <div className="card overflow-visible card-flush py-4">
                                                <div className="text-center">
                                                    <p className="fw-bolder fs-7"><Skeleton width={280} /></p>
                                                </div>
