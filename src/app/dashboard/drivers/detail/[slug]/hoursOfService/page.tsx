...
export default function HoursOfService({ params }) {
  ...
  const getCookie = (name) => {
    if (typeof window === "undefined") {
      // Code is running on the server, `document` is not available
      return null;
    }
  ...
  useEffect(() => {
    if (driverId && log && graphDataMap && data) {
      setIsDataLoading(true);
    }
  }, [driverId, log, graphDataMap, data]);
      ...
      <div className="d-flex justify-content-between">
        <h3 className="align-items-start flex-column fs-2 fw-bold text-gray-800 mt-5">
          ...
          <span className="border-bottom border-3 border-dark">
            {data && data[0] && data[0][0] ? data[0][0].first_name : "N/A"}{" "}
            {data && data[0] && data[0][0] ? data[0][0].last_name : "N/A"}
          </span>{" "}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <div className="d-flex justify-content-around">
          <div className="p-5">
            ...
            <span className="badge text-bg-dark fs-5">
              {data && data[0] && data[0][5] ? data[0][5] : ""}
            </span>
          </div>
          <div className="p-5">
            <p>Time in current status</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][2] ? data[0][2] : "00:00:00"}
            </span>
          </div>
          <div className="p-5">
            <p>Vehicle Name</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][1] ? data[0][1].name : ""}
            </span>
          </div>
          <div className="p-5">
            <p>Time until break</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][8] ? data[0][8] : "00:00:00"}
            </span>
          </div>
          <div className="p-5">
            <p>Drive remaining</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][7] ? data[0][7] : "00:00:00"}
            </span>
          </div>
          <div className="p-5">
            <p>Shift remaining</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][4] ? data[0][4] : "00:00:00"}
            </span>
          </div>
          <div className="p-5">
            <p>Cycle remaining</p>
            <span className="fs-5 fw-semibold">
              {data && data[0] && data[0][6] ? data[0][6] : "00:00:00"}
            </span>
          </div>
        </div>
      </div>
