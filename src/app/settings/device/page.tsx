                                ...
                                <table className="table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_tr_u_table">
                                    <thead>
                                        <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            <th className="min-w-125px" style={{ width: 308.733 }}>DEVICE TYPE</th>
                                            <th className="min-w-125px" style={{ width: 125 }}>GATEWAY SERIAL</th>
                                            <th className="min-w-125px" style={{ width: 125 }}>SERIAL NUMBER</th>
                    ...
                    <div className="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div className="table-responsive">
                            <table className="table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_tr_u_table">
                                <thead>
                                    <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        <th className="min-w-125px" style={{ width: 125 }}>Device type</th>
                                        <th className="min-w-125px" style={{ width: 125 }}>Hardware</th>
                                        <th className="min-w-125px" style={{ width: 125 }}>Serial Number</th>
                                        <th className="min-w-125px" style={{ width: 125 }}>Gateway serial</th>
                                        <th className="min-w-125px" style={{ width: 125 }}>Gateway</th>
                                ...
                                <tbody className="text-gray-600 fw-semibold">
                                    {device && device.map((data) => (
                                        <tr className="odd" key={data.id}>
                                            <td>
                                                {data?.device_type?.device_type_name}
                                            </td>
                                            <td>
                                                {data?.hardware?.hardware_name}
                                            </td>
                                            ...
                                            {permissn.includes(34) && (
                                                <td className="text-end">
                                                    <Link href={`./device/${data.id}`} className="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm">
